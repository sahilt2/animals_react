...
const About = () => {
    return (
        <div>
            ...
            Possimus ipsam quibusdam architecto! Vero voluptatibus nisi ex autem repudiandae error blanditiis totam placeat voluptate accusantium veniam maiores expedita animi fugit consequatur enim, odio fugiat neque sint iusto dolore quibusdam!
            Magnam natus doloribus quos libero maiores, quod laborum repudiandae saepe, dolorem consectetur voluptas iure placeat harum odit rerum minus nesciunt a ut doloremque. Possimus, officiis soluta? Quo nobis repudiandae voluptate.</p>
        </div>
    );
};
